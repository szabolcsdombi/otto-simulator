...
resolved = ctx.image((1280, 720), 'rgba8unorm', texture=False)
image = ctx.image((1280, 720), 'rgba8unorm', samples=16)
depth = ctx.image((1280, 720), 'depth24plus', samples=16)
...
pipeline = ctx.pipeline(
    ...
    fragment_shader='''
        ...
        void main() {
            ...
            out_color = vec4(pow(v_color * (u * v), vec3(1.0 / 2.2)), 1.0);
        }
    ''',
